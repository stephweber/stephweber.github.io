...
/***/ function(module, exports, __webpack_require__) {
	...
	window.onload = function () {
	  return Page.init(document.getElementById("page"));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var fonts = _require2.fonts;
	var ss = _require2.ss;

	var PageContent = __webpack_require__(167);

	var normalizeTabName = function normalizeTabName(name) {
	...
	var Header = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                "div",
	                { className: css(styles.nameBlock) },
	                React.createElement(
	                    "div",
	            ...
	            React.createElement(
	                "div",
	                null,
	                React.createElement("img", { src: "images/photo.png", className: css(styles.portrait) })
	            )
	        );
	    }
	});
	...
	var Footer = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            "div",
	            { className: css(styles.licenseContainer) },
	            React.createElement(
	                "div",
	            ...
	            React.createElement(
	                "div",
	                { className: css(styles.licenseText) },
	                "Text and images on this site are licensed under a ",
	                React.createElement(
	                    "a",
	                    {
	...
	var NavItem = React.createClass({
	    ...
	    render: function render() {
	        var normalizedName = normalizeTabName(this.props.name);
	        return React.createElement(
	            "a",
	            {
	                className: css(styles.navItem, styles.navLinkText, normalizedName === this.props.selectedName && styles.selectedNavItem),
	                href: "/index.html?" + normalizeTabName(this.props.name),
	                onClick: this.onClick
	            },
	            React.createElement(
	                "span",
	                { className: css(styles.navLinkText) },
	                this.props.name
	            )
	        );
	    }
	...
	var Page = React.createClass({
	    ...
	    selectedFromURL: function selectedFromURL() {
	    ...
	    selectSection: function selectSection(section) {
	        if (window.location.search.length === 0 || window.location.search.slice(1) !== section) {
	            window.history.pushState(this.state.selected, null, this.urlFromSelected(section));
	        }
	        this.setState({ selected: section });
	    },

	    urlFromSelected: function urlFromSelected(selected) {
	        return "/index.html?" + selected;
	    },

	    render: function render() {
	        var Content = PageContent[this.state.selected];
	        return React.createElement(
	            "div",
	            { className: css(styles.page) },
	            React.createElement(
	                "div",
	                { className: css(styles.pageInner) },
	                ...
	                React.createElement(
	                    ...
	                    Content ? React.createElement(Content, null) : null
	                ),
	...
	Page.init = function (domNode) {
	    ReactDOM.render(React.createElement(Page, null), domNode);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _inject = __webpack_require__(162);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _asap = __webpack_require__(163);

	var _asap2 = _interopRequireDefault(_asap);

	var _generate = __webpack_require__(165);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var rawAsap = __webpack_require__(164);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = { colors: colors, fonts: fonts, ss: ss };
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                "p",
	                null,
	                "Both prokaryotic and eukaryotic cells are crowded with macromolecules that form highly organized yet dynamic structures. While advances in fluorescence microscopy enable us to visualize this spatiotemporal heterogeneity, the physical mechanisms underlying intracellular organization remain largely unknown. I am interested in understanding how biological systems establish and dynamically regulate spatial order in the cell and how these processes affect growth and size of the whole organism."
	            ),
	            React.createElement(
	                "div",
	                { className: css(styles.imageRow) },
	                React.createElement(
	                    "div",
	                    { className: css(styles.imageWithCaption) },
	                    React.createElement("img", {
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    "div",
	                    { className: css(styles.researchSection) },
	                    React.createElement(
	                        "div",
	                        { className: css(styles.researchContent) },
	                        React.createElement(
	                            "div",
	                            { className: css(styles.researchText) },
	                            React.createElement(
	                                "div",
	                            ...
	                            ", I investigated size control mechanisms in the nematode Caenorhabditis elegans. Using 3D confocal microscopy and quantitative image analysis, I characterized the assembly and growth dynamics of the nucleolus in developing embryos. The nucleolus is a non-membrane bound organelle that produces ribosomes, molecular machines essential for cell growth and size homeostasis. I discovered that these organelles are governed by a concentration-dependent phase transition, in which soluble components condense into liquid-like droplets only above a threshold concentration. In collaboration with ",
	                            React.createElement(
	                                "a",
	                                {
	                                    href: links.joel,
	                            ...
	                            ", I found that nucleoli coarsen via Brownian coalescence and Ostwald ripening. Furthermore, RNA transcription appears to stabilize nucleoli and accelerate coaresening. Thus, non-equilibrium biological activity may modulate classical phase separation to regulate organelle size (and activity) in response to developmental or environmental conditions."
	                        ),
	                        React.createElement(
	                            "div",
	                            { className: css(styles.researchImageSection) },
	                            React.createElement("img", {
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            ...
	                            ", I explored the physical and biological mechanisms underlying macromolecular motion in vivo. Segments of chromosomal DNA jiggle in place in the crowded bacterial cytoplasm. By tracking the position of these loci over time, I found a robust subdiffusive scaling law for the mean square displacement. To identify the source of this anomalous behavior, I collaborated with ",
	                            React.createElement(
	                                "a",
	                                {
	                                    href: links.spak,
	                        ...
	                        React.createElement(
	                            "div",
	                            {
	                                className: css(styles.researchImageSection, styles.researchImageSectionSideBySide)
	                            },
	                            React.createElement("img", {
	                                className: css(styles.researchImage, styles.h177),
	                                src: "images/phaseFluor84.png"
	                            }),
	                            React.createElement(
	                                "div",
	                                {
	                                    className: css(styles.caption, styles.sideCaption)
	                                },
	                                "Fluorescent and phase contrast images of an ",
	                                React.createElement(
	                                    "span",
	                                    { className: css(styles.latinName) },
	                                    "E. coli"
	                                ),
	                                " cell with the replicated 84’ locus visualized by parS/GFP-ParB."
	                            )
	                        )
	                    )
	                ),
	                React.createElement(
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            ...
	                            React.createElement("img", {
	                                className: css(styles.researchImage, styles.h265),
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                "p",
	                null,
	                "As a teacher, my goal is to develop creative, independent problem-solvers who are curious about the natural world. My students learn the process of science, as well as specific knowledge. They practice critical thinking skills that will be valuable both within and beyond the classroom. To help my students reach these goals, I create an interactive classroom that encourages questions, promotes discussions and stimulates debates. I aim to provide a challenging but supportive environment where students can learn from each other as well as from me."
	            ),
	            React.createElement(
	                "div",
	                { className: css(styles.subtitle) },
	            ...
	            React.createElement(
	                "div",
	                { className: css(styles.evaluation) },
	                React.createElement(
	                    "p",
	                    null,
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    "p",
	                    null,
	                    "\"The strongest part of this course was Steph Weber. She is the most engaged and brilliant person I have met at Stanford.\""
	                ),
	                React.createElement(
	                    "p",
	                    { className: css(styles.source) },
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    "p",
	                    null,
	                    "\"Her genuine enthusiasm for the material also shines through her teaching, which was very clearly guided by goals she presented clearly to the class.\""
	                ),
	                React.createElement(
	                    "p",
	                    { className: css(styles.source) },
	            ...
	            React.createElement("br", null),
	            "CBE433, Mechanics and Dynamics of Soft Living Matter, Princeton University",
	            React.createElement("br", null),
	...
	var Publication = React.createClass({
	    ...
	    render: function render() {
	        var pubmedLink = React.createElement(
	            "span",
	            null,
	            "(",
	            React.createElement(
	        ...
	        var hasCommentary = this.props.commentary || this.props.commentaryLink;
	        var commentaryHref = this.props.commentaryLink || "http://www.ncbi.nlm.nih.gov/pubmed/" + this.props.commentary;
	        var commentary = hasCommentary ? React.createElement(
	            "span",
	            null,
	            "(",
	            React.createElement(
	        ...
	        return React.createElement(
	            Item,
	            { className: css(styles.publication) },
	            React.createElement(
	                "span",
	                null,
	                this.props.authors,
	...
	var PublicationContent = React.createClass({
	    ...
	    render: function render() {
	        var Wrapper = this.props.wrapperType;
	        return React.createElement(
	            Wrapper,
	            null,
	            React.createElement(Publication, {
	                ...
	                pmid: "26351690",
	                authors: "Berry, J. M.*, Weber, S. C.*, Vaidya, N. Haataja, M." + " and Brangwynne, C. P.",
	                year: "2015",
	                text: "RNA transcription modulates phase " + "transition-driven nuclear body assembly"
	            }),
	            React.createElement(Publication, {
	                itemType: this.props.itemType,
	                ...
	                year: "2015",
	                text: "Inverse size scaling of the nucleolus by a " + "concentration-dependent phase transition"
	            }),
	            React.createElement(Publication, {
	                itemType: this.props.itemType,
	                journal: "Cell",
	            ...
	            React.createElement(Publication, {
	                ...
	                year: "2012",
	                text: "Analytical tools to distinguish the effects " + "of localization error, confinement and medium" + "elasticity on the velocity autocorrelation " + "function"
	            }),
	            React.createElement(Publication, {
	                itemType: this.props.itemType,
	                journal: "Proceedings of the National Academy of Sciences",
	            ...
	            React.createElement(Publication, {
	                ...
	                postScript: "238102",
	                pmid: "20867274",
	                commentaryLink: "http://physics.aps.org/synopsis-for/10.1103" + "/PhysRevLett.104.238102",
	                authors: "Weber, S. C., Spakowitz, A. J. and Theriot, J. A.",
	                year: "2010",
	                text: React.createElement(
	                    "span",
	...
	var Publications = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(PublicationContent, {
	                itemType: 'li',
	                wrapperType: 'ul'
	            })
	        );
	...
	var CVItem = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            "div",
	            { className: css(styles.cvItem) },
	            React.createElement(
	                "div",
	                { className: css(styles.cvTextWithDescription) },
	                React.createElement(
	                    "div",
	                    { className: css(styles.cvText) },
	                    this.props.text
	                ),
	                this.props.description ? React.createElement(
	                    "div",
	                    { className: css(styles.cvDescription) },
	                    this.props.description
	                ) : null
	            ),
	            React.createElement(
	                "div",
	                { className: css(styles.cvDate) },
	                this.props.date
	            )
	        );
	    }
	...
	var CVSection = React.createClass({
	    displayName: "CVSection",
	    ...
	    render: function render() {
	        return React.createElement(
	            "div",
	            { className: css(styles.cvSection) },
	            React.createElement(
	                "div",
	                { className: css(styles.subtitle) },
	                this.props.name
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(CVItem, {
	                    date: "2011-2015",
	                    text: "Postdoctoral fellow with Cliff Brangwynne, " + "Princeton University",
	                    description: React.createElement(
	                        "span",
	                        null,
	                        "An intracellular phase transition couples nucleolar size with cell size in early ",
	                        React.createElement(
	                            "span",
	                            {
	                                className: css(styles.latinName)
	                ...
	                React.createElement(CVItem, {
	                    date: "2007-2011",
	                    text: "Graduate student with Julie Theriot, " + "Stanford Univeristy",
	                    description: React.createElement(
	                        "span",
	                        null,
	                        ...
	                        ": anomalous diffusion through an \"active\" viscoelastic medium"
	                    )
	                }),
	                React.createElement(CVItem, {
	                    date: "2005-2006",
	                    text: "Undergraduate student with Arno Greenleaf, " + "Duke University",
	                    description: "FF domains and the binding of PCAPs to the " + "carboxy terminal domain of RNA polymerase II"
	                }),
	                React.createElement(CVItem, {
	                    date: "2004",
	                    text: "Summer student with Kerry O'Banion, " + "University of Rochester",
	                    description: "The use of RNA interference to elucidate " + "the role of mPGES-1 in PGE2 biosynthesis"
	                }),
	                React.createElement(CVItem, {
	                    date: "2003-2005",
	                    text: "Undergraduate student with Steve Haase, " + "Duke University",
	                    description: React.createElement(
	                        "span",
	                        null,
	                        "The effect of CLB6 on population doubling time in ",
	                        React.createElement(
	                            "span",
	                            {
	                                className: css(styles.latinName)
	            ...
	            React.createElement(
	                CVSection,
	                { name: "Honors, Awards, and Fellowships" },
	                React.createElement(CVItem, {
	                    date: "2012-2015",
	                ...
	                React.createElement(CVItem, {
	                    date: "2012",
	                    text: "Jane Coffin Childs Memorial Fund Postdoctoral " + "Fellowship (declined)"
	                }),
	                React.createElement(CVItem, {
	                    date: "2012",
	                    text: "Life Sciences Research Foundation Postdoctoral " + "Fellowship (declined)"
	                }),
	                React.createElement(CVItem, {
	                    date: "2011",
	                ...
	                React.createElement(CVItem, {
	                    ...
	                    description: "National award recognizing outstanding " + "achievement in graduate studies in the " + "biological sciences"
	                }),
	                React.createElement(CVItem, {
	                    date: "2008-2011",
	                ...
	                React.createElement(CVItem, {
	                    ...
	                    description: "Highest honor bestowed upon a Duke " + "undergraduate recognizing intellectual " + "leadership and scholarly accomplishment"
	                }),
	                React.createElement(CVItem, {
	                    date: "2005",
	                    text: "Phi Beta Kappa"
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    "div",
	                    { className: css(styles.talk) },
	                    "Weber, S. C., Berry, J. M., Vaidya, N., Haataja, M. and Brangwynne, C. P. (2015) RNA transcription modulates phase transition-driven nucleolar assembly, American Society for Cell Biology, Annual Meeting."
	                ),
	                React.createElement(
	                    "div",
	                    { className: css(styles.talk) },
	                    "Weber, S. C. and Brangwynne, C. P. (2014) Nucleolar assembly and growth are governed by a concentration-dependent phase transition, American Society for Cell Biology, Annual Meeting."
	                ),
	                React.createElement(
	                    "div",
	                    { className: css(styles.talk) },
	                    "Weber, S. C. and Brangwynne, C. P. (2014) Inverse size scaling of the nucleolus by a concentration-dependent phase transition, Biophysical Society, Disordered Motifs and Domains in Cell Control."
	                ),
	                React.createElement(
	                    "div",
	                    { className: css(styles.talk) },
	                    "Weber, S. C. and Brangwynne, C. P. (2014) Nucleolar size and assembly is governed by a concentration-dependent phase transition, Gordon Research Conference, Post-Transcriptional Gene Regulation."
	                ),
	                React.createElement(
	                    "div",
	                    { className: css(styles.talk) },
	                    "Weber, S. C., Spakowitz, A. J. and Theriot, J. A (2010) ATP-dependent fluctuations drive macromolecular motion ",
	                    React.createElement(
	                        "span",
	                        { className: css(styles.latinName) },
	                        "in vivo"
	            ...
	            React.createElement(
	                CVSection,
	                { name: "Teaching/Mentoring Experience" },
	                React.createElement(CVItem, {
	                    date: "2015-present",
	                ...
	                React.createElement(CVItem, {
	                    date: "2013-2015",
	                    text: "Pedagogical training through the Teaching " + "Transcript Program, The McGraw Center, " + "Princeton Unviersity"
	                }),
	                React.createElement(CVItem, {
	                    date: "Autumn 2012, 2014",
	                    text: "Guest Lecturer, CBE433/533 Mechanics and " + "Dynamics of Soft Living Matter " + "Princeton University"
	                }),
	                React.createElement(CVItem, {
	                    date: "2011-2015",
	                    text: "Mentoring high school, undergraduate, senior " + "thesis and graduate students " + "Princeton University"
	                }),
	                React.createElement(CVItem, {
	                    date: "Autumn 2010",
	                    text: "Teaching Assistant, BIOE41 Physical Biology " + "of Macromolecules, Stanford University"
	                }),
	                React.createElement(CVItem, {
	                    date: "Summer 2008",
	                    text: "Teaching Assistant, Physiology Course, " + "Marine Biological Laboratory, Woods Hole, MA"
	                }),
	                React.createElement(CVItem, {
	                    date: "Winter, Spring 2008",
	                    text: "Teaching Assistant, BIO109 The Human Genome " + "and Disease, Stanford University"
	                })
	            ),
	            React.createElement(
	                CVSection,
	                ...
	                React.createElement(CVItem, {
	                    ...
	                    description: "Served as a table leader for a Career " + "Discussion Roundtable at the American " + "Society for Cell Biology's Annual Meeting."
	                }),
	                React.createElement(CVItem, {
	                    date: "2013-2015",
	                    text: "Princeton Postdoc Council",
	                    description: "Served as liaison between postdocs and " + "administration; organized professional " + "development and social events for the " + "postdoctoral community at Princeton"
	                }),
	                React.createElement(CVItem, {
	                    date: "2013-2015",
	                    text: "Mentoring Program",
	                    description: "Coordinated mentoring relationships " + "between postdocs and graduate students, " + "in collaboration with Graduate Women in " + "Science and Engineering (GWISE)"
	                }),
	                React.createElement(CVItem, {
	                    date: "2012-2015",
	                    text: "Outreach",
	                    description: "Designed and delivered lectures and lab " + "activities for middle school students " + "at Stuart Country Day School in " + "Princeton, NJ and Kilmer Elementary " + "School in Trenton, NJ"
	                })
	            ),
	            React.createElement(
	                CVSection,
	            ...
	            React.createElement(
	                "a",
	                { className: css(ss.link), href: "Weber_CV.pdf" },
	                "PDF version"
	            )
	        );
	    }
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    "We are actively recruiting students and postdocs to join our interdisciplinary team. If you are passionate about science and eager to address challenging problems at the interface of cell biology and physics, then contact ",
	                    React.createElement(
	                        "a",
	                        {
	                            className: css(ss.link),
	                ...
	                React.createElement(
	                    ...
	                    React.createElement("img", {
	                        className: css(styles.researchImage, styles.montrealImage),
